...
class fuzzy_system:
    ...
    def mem_force(self, pa, pv, cv):
        ...
        stop = max(max(min(self.pa_up(pa), self.pv_stop(pv)), min(self.pa_up_right(pa), self.pv_ccw_slow(pv)),
                       min(self.pa_up_left(pa), self.pv_cw_slow(pv))),
                   min(self.pa_down_more_right(pa), self.pv_cw_slow(pv)),
                   min(self.pa_down_more_left(pa), self.pv_ccw_slow(pv)), min(self.pa_down(pa), self.pv_ccw_fast(pv)),
                   min(self.pa_up(pa), self.pv_stop(pv)), min(self.pa_down(pa), self.pv_cw_fast(pv)),
                   min(self.pa_down_left(pa), self.pv_cw_fast(pv)), min(self.pa_down_right(pa), self.pv_ccw_fast(pv)),
        ...
        right_fast = max(min(self.pa_up_more_right(pa), self.pv_ccw_slow(pv)),
                         ...
                         min(self.pa_down_more_right(pa), self.pv_ccw_slow(pv)), min(
                self.pa_down_right(pa), self.pv_ccw_slow(pv)), min(self.pa_down_right(pa), self.pv_cw_slow(pv)),
                         min(self.pa_up_right(pa), self.pv_cw_slow(pv)), min(self.pa_up_right(pa), self.pv_stop(pv)),
                         min(self.pa_up_right(pa), self.pv_cw_fast(pv)), min(self.pa_up_left(pa), self.pv_cw_fast(pv)),
                         min(self.pa_down(pa), self.pv_stop(pv)), min(self.pa_up(pa), self.pv_cw_fast(pv)),
                         min(self.cv_left_fast(cv), self.pv_stop(pv)), min(self.cv_left_fast(cv), self.pv_cw_fast(pv)),
                         min(
        ...
        left_fast = max(min(self.pa_up_more_left(pa), self.pv_ccw_slow(pv)),
                        ...
                        min(self.pa_down_more_left(pa), self.pv_cw_slow(pv)), min(
                self.pa_down_left(pa), self.pv_cw_slow(pv)), min(self.pa_down_left(pa), self.pv_ccw_slow(pv)),
                        min(self.pa_up_left(pa), self.pv_ccw_slow(pv)), min(self.pa_up_left(pa), self.pv_stop(pv)),
                        min(self.pa_up_left(pa), self.pv_ccw_fast(pv)), min(self.pa_up_right(pa), self.pv_ccw_fast(pv)),
                        min(self.pa_up(pa), self.pv_ccw_fast(pv)), min(self.cv_right_fast(cv), self.pv_stop(pv)),
                        min(self.cv_right_fast(cv), self.pv_ccw_fast(pv)), min(
        ...
        left_slow = max(min(self.pa_up_more_right(pa), self.pv_ccw_fast(pv)),
                        min(self.pa_down_left(pa), self.pv_ccw_fast(pv)), min(
                self.pa_up_left(pa), self.pv_cw_slow(pv)
            ), min(self.pa_up(pa), self.pv_ccw_slow(pv)), min(self.cv_right_fast(cv), self.pv_cw_slow(pv)),
        ...
        right_slow = max(min(self.pa_up_more_left(pa), self.pv_cw_fast(pv)),
                         min(self.pa_down_right(pa), self.pv_cw_fast(pv)), min(
                self.pa_up_right(pa), self.pv_ccw_slow(pv)
            ), min(self.pa_up(pa), self.pv_cw_slow(pv)), min(self.cv_left_slow(cv), self.pv_ccw_slow(pv)),
                         min(self.cv_right_slow(cv),
